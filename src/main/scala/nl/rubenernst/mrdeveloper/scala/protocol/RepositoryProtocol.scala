...
object RepositoryProtocol {
  ...
  final case class StarRepository(id: Long, fullName: String) extends RepositoryCommand
  ...
  final case class RepositoryStarred(id: Long, fullName: String) extends RepositoryEvent
